...
....
J'ai d'abord vérifier que j'etais dans le bonne endroit: cd /Users/juliacastellanothomson/hello/devine_mon_nombre/src, je suis dans le repertoire src.
Je le compile avec cargo: cargo run --bin devine_mon_nombre.
Apres l'execution elle affich : "Hello, world!"
